...
-   [knit_print.data.frame](./R/knit_print.data.frame.R) which changed to a method (no longer an exported function) possibly after R 4.3.1 or maybe an update to devtools or similar package.
